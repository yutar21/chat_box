...
import 'package:chat/Presentation/view/JoinRoom/JoinRoomViewModel.dart';
...
class _JoinRoomScreenState extends BaseState<JoinRoomScreen, JoinRoomViewModel>
                ...
                child: SingleChildScrollView(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Xin chào, Chào mừng đến với phòng trò chuyện của chúng tôi",
  ...
  JoinRoomViewModel initialViewModel() {
    return JoinRoomViewModel(
        AddUserToRoomUseCase(injectRoomDataRepo(), injectUserRepo()));
  }
