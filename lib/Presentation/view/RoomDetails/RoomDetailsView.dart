...
import 'package:chat/Presentation/view/RoomDetails/RoomDetailsNavigator.dart';
import 'package:chat/Presentation/view/RoomDetails/RoomDetailsViewModel.dart';
import 'package:chat/Presentation/view/RoomDetails/Widgets/MyBottomSheatWidget.dart';
import 'package:chat/Presentation/view/RoomDetails/Widgets/WhiteSpaceWidget.dart';
...
class _RoomDetailsViewState
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    viewModel!.provider!.user!.uid ==
                                            viewModel!.room!.ownerId
                                        ? TextButton(
                                            onPressed: value
  ...
  goToUpdateRoomDetailsScreen(Room room) {
    Navigator.pushNamed(context, UpdateRoomDetailsView.routeName,
        arguments: room);
  }
}
