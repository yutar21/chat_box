...
import 'package:chat/Presentation/view/Search/SearchNavigator.dart';
import 'package:chat/Presentation/view/Search/SearchViewModel.dart';
...
class _SearchViewState extends BaseState<SearchView, SearchViewModel>
                  ...
                  if (value.errorMessage != null) {
                    ...
                    return GridView.builder(
                      ...
                      itemBuilder: (context, index) => CardWidget(
                          ...
                          navigate: value.rooms[index].users.contains(value.uid)
                              ? value.goToChatScreen
                              : value.goToJoinRoomScreen),
                    );
                  }
                },
              ),
