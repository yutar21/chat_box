...
import 'package:chat/Presentation/view/Create%20Room/CreateRoomViewModel.dart';
...
class _CreateRoomViewState
  ...
  CreateRoomViewModel initialViewModel() {
    return CreateRoomViewModel(
        AddRoomUseCase(injectRoomDataRepo(), injectUserRepo()));
  }
                                ...
                                Container(
                                  ...
                                  child: DropdownButton<RoomType>(
                                    ...
                                    items: viewModel!.types
                                        .map<DropdownMenuItem<RoomType>>((e) =>
